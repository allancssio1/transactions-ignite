...
if (!_env.success) {
  console.error("Ivalid environment variabes", _env.error.format());
  throw new Error("Ivalid environment variabes");
}
var env = _env.data;
...
var KnexDB = (0, import_knex.knex)(config2);

// src/routes/transations.ts
var import_zod2 = require("zod");

// src/middlewares/checkSessionIdExists.ts
var checkSessionIdExists = async (req, reply) => {
